...
def default_capability_catalog() -> list[CapabilityPolicy]:
    return [
        CapabilityPolicy(
            ...
            keywords=["政策", "准入", "适合", "哪些企业", "企业类型", "条件", "产品"],
        ...
        CapabilityPolicy(
            ...
            keywords=["额度", "能贷", "多少钱", "授信", "融资准入", "贷款支持"],
